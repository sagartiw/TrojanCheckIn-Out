...
public class SearchStudentsViewHistoryTest {
    ...
    public void searchStudentsViewHistoryTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textView27), withText("Visit History"),
                        withParent(withParent(withId(R.id.cardView))),
                        isDisplayed()));
        textView.check(matches(withText("Visit History")));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.nameTitle4), withText("annika oeth"),
                        withParent(withParent(withId(R.id.cardView))),
                        isDisplayed()));
        textView2.check(matches(withText("annika oeth")));
