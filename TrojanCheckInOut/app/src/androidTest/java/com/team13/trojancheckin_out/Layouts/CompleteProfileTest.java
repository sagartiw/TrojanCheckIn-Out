...
public class CompleteProfileTest {
    ...
    public void completeProfileTest() {
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.editTextTextPersonName4),
                        childAtPosition(
                                ...
                                12),
                        isDisplayed()));
        appCompatEditText8.perform(replaceText("1234567891"), closeSoftKeyboard());

        ViewInteraction appCompatEditText9 = onView(
                allOf(withId(R.id.editTextTextPersonName4), withText("1234567891"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction materialRadioButton = onView(
                allOf(withId(R.id.radioButton3), withText("Student"),
                        childAtPosition(
