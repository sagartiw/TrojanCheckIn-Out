    ...
    public void signOutManagerTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.editTextTextEmailAddress2),
                        childAtPosition(
                                ...
                                6),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("ksa@usc.edu"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textView), withText("trojan"),
                        ...
                        isDisplayed()));
        textView.check(matches(withText("trojan")));
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.textView2), withText("check in/out"),
                        withParent(allOf(withId(R.id.ConstraintLayout),
                                withParent(withId(android.R.id.content)))),
                        isDisplayed()));
        textView2.check(matches(withText("check in/out")));
